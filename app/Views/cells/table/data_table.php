                    ...
                    <td style="white-space:nowrap;"> 
                        <div class='btn-group'> <?php
                        	foreach($arr_clickable as $item2){ 
                                ...
                                $id = $item[$kolom_id]; 
                                $class = $item2['class'];
                                if($item2['confirm_func'] != null && $item2['confirm_msg'] != null){ ?>
                                	<form method="POST" action="<?= $item2['href'] ?>" onsubmit ="return <?= $item2['confirm_func'] ?>()"> <?php
                                }else{ ?>
                                	<form method="POST" action="<?= $item2['href'] ?>"> <?php
                                } ?>
